package com.perpetual.sokomart.ui.screens.intent
...
fun IntentScreen(navController: NavController) {
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.startscreen),
        ...
        Button(
            onClick = {
                ...
                callIntent.data = "tel:0792851592".toUri()
        ...
        Button(
            onClick = {
                ...
                smsIntent.data = "smsto:0792851592".toUri()
                smsIntent.putExtra("sms_body", "Hello Perpetual,how was your day?")
